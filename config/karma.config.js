...
module.exports = function (config) {
  ...
  config.htmlReporter = {
    outputDir: path.join(
      gulp_core_build.getConfig().tempFolder,
      "karma-html-report"
    ),
    templatePath: null,
    focusOnFailures: true,
    namedFiles: true,
    pageTitle: "gobigfoot-controls-react unit-tests report",
    urlFriendlyName: false,
    reportName: "gobigfoot-controls-react-report",
  };
